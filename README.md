### cs301-F2021-Activity01-starter
...
### Instructions
Please follow the tutorial to learn more about determining outliers in data at the following link, [https://statsandr.com/blog/outliers-detection-in-r/](https://statsandr.com/blog/outliers-detection-in-r/). Take your time to think through each line of code to understand what it is doing and then try running it on your own machine. As you work, place this code into `/src/outliers.r` and then answer the questions at in `/writing/discussion.md`.

### Due
This activity must be submitted (i.e., pushed) to your GitHub work repository by the start of the next class.
